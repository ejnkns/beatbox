...
export const frequencyToNote = (frequency: number): NoteData | undefined => {
	...
	return noteName && octave !== undefined && cents !== undefined
		? {
				name: noteName,
				octave,
				cents,
...
export const formatNoteDate = (note: Partial<NoteData> | undefined) => {
...
const getBaseNote = (note: BaseNote | BaseNoteOctave) => {
...
const getOctave = (note: BaseNote | BaseNoteOctave) => {
...
export const noteToFrequency = (note: NoteData | BaseNote | BaseNoteOctave) => {
...
export const noteToIndex = (note: NoteData | BaseNoteOctave) => {
	const noteData = typeof note === "string" ? makeNoteData(note) : note;
